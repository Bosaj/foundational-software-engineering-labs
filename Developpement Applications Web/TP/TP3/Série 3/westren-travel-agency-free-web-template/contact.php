...
<head>
<meta charset="utf-8">
<title>Western Multi purpose HTML5 Web Template</title>
...
<div class="topbar">
  <div class="container">
	...
	<div class="row">
		   ...
		   <!-- Form itself -->
          <form action ="post" method="verify.php" name="sentMessage" id="contactForm"  novalidate>
	       <h3>Let us know</h3>
		 <div class="control-group">
                    <div class="controls">
			<input type="text" class="form-control" 
			   	   placeholder="Full Name" id="name" required name="fullname"
