...
print(
    "Méthode 3 (enumerate()) :",
    trouver_position_enumerate(element_recherche, mon_tuple),
)
print(
    "Méthode 4 (index() avec gestion des exceptions) :",
    trouver_position_index_exception(element_recherche, mon_tuple),
)
