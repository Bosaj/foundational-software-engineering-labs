...
[
    liste_sans_doublons_in.append(element)
    for element in list_doublons
    if element not in liste_sans_doublons_in
]

# Méthode 2 : Utilisation de la méthode count()
liste_sans_doublons_count = []
[
    liste_sans_doublons_count.append(element)
    for element in list_doublons
    if list_doublons.count(element) == 1
]
...
liste_sans_doublons_filter = list(
    filter(lambda x: list_doublons.count(x) == 1, list_doublons)
)
...
print(
    "Liste sans doublons (utilisant la conversion en ensemble) :",
    liste_sans_doublons_set,
)
print(
    "Liste sans doublons (utilisant la fonction OrderedDict) :",
    liste_sans_doublons_ordered,
)
print(
    "Liste sans doublons (utilisant la méthode remove() avec une boucle) :",
    liste_sans_doublons_remove,
)
print(
    "Liste sans doublons (utilisant la méthode comprehension de liste avec filter) :",
    liste_sans_doublons_filter,
)
