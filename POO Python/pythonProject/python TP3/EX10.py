...
def livres_par_auteur_comprehension_dict(livres):
    return {auteur: [livre["titre"] for livre in livres if livre["auteur"] == auteur] for auteur in set(livre["auteur"] for livre in livres)}
...
print("Méthode 2 (boucle for avec setdefault()) :", livres_par_auteur_setdefault(livres))
print("Méthode 3 (compréhension de dictionnaire) :", livres_par_auteur_comprehension_dict(livres))
